        ...
        <div class="container">
            ...
            <div class="pull-right">
                <div class="beta-breadcrumb font-large">
                    <a href="index.html">{{ trans('home.home')}}</a> / <span>{{ trans('home.shoppingCart') }}</span>
                </div>
            </div>
    ...
    <div class="container">
        <div id="content">
                            ...
                            <td class="product-name">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="table-option"></p>
                                        <a class="table-edit" href="#">{{ trans('home.Edit')}}</a>
                                    </div>
                                </div>
                            </td>
            ...
            <div class="cart-collaterals">
                {!! Form::open(['method' => 'POST','class' => 'shipping_calculator pull-left']) !!}
                    ...
                    <section class="shipping-calculator-form " style="display: none;">
                        ...
                        <p class="form-row form-row-wide">
                            {!! Form::hidden('calc_shipping_state', '' , ['class' => 'form-control', 'id' => 'calc_shipping_state']) !!}
                        </p>
                        <p class="form-row form-row-wide">
                            {!! Form::text('calc_shipping_state', '' , ['class' => 'input-text', 'id' => 'calc_shipping_state']) !!}
                        </p>
