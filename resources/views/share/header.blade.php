            ...
            <div class="row">
                                        ...
                                        <li><a href="#">{{ __('men') }}</a>
                                            <div class="wrap-popup">
                                                <div class="popup">
                                                    ...
                                                    <br>
                                                    <a href="#" class="ads"><img src="images/jtv-menu-banner4.jpg" alt="Mega Sale" class="img-responsive"></a>
                                                </div>
                                            </div>
                                        </li>
                                                        ...
                                                        <div class="col-md-4 has-sep hidden-sm">
                                                            <div class="custom-menu-right">
                                                                <div class="box-banner media">
                                                                    ...
                                                                    <div class="add-right">
                                                                        <img src="images/jtv-menu-banner2.jpg" alt="Top Glass" class="img-responsive">
                                                                    </div>
                                                                </div>
                                                                <div class="box-banner media">
                                                                    <div class="add-desc">
                                                                    ...
                                                                    <div class="add-right">
                                                                        <img src="images/jtv-menu-banner3.jpg" alt="Save 35%" class="img-responsive">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="col-lg-9 col-sm-9 col-xs-12 jtv-rhs-header">
                    <div class="jtv-mob-toggle-wrap">
                        <div class="mm-toggle">
                            <i class="fa fa-reorder"></i><span class="mm-label">{{ __('Menu') }}</span>
                        </div>
                    </div>
                            ...
                            <div class="right_menu">
                                <div class="menu_top">
                                    <div class="top-cart-contain pull-right">
                                        <div class="mini-cart">
                                            <div class="basket">
                                                <a class="basket-icon" href="#"><i class="fa fa-shopping-basket"></i> {{ __('ShoppingCart') }} <span>3</span></a>
                                                <div class="top-cart-content">
                                                    ...
                                                    <ul class="mini-products-list" id="cart-sidebar">
                                                        <li class="item">
                                                            <div class="item-inner">
                                                                <a class="product-image" title="product tilte is here" href="product-detail.html"><img alt="product tilte is here" src="images/products/product-fashion-1.jpg"></a>
                                                                <div class="product-details">
                                                                    <div class="access">
                                                                        <a class="btn-remove1" title="Remove This Item" href="#">{{ __('Remove') }}</a> <a class="btn-edit" title="Edit item" href="#"><i class="fa fa-pencil"></i><span class="hidden">{{ __('Edititem') }}</span></a>
                                                                    </div>
                                                        ...
                                                        <li class="item">
                                                            <div class="item-inner">
                                                                <a class="product-image" title="Product tilte is here" href="product-detail.html"><img alt="Product tilte is here" src="images/products/product-fashion-3.jpg"></a>
                                                                <div class="product-details">
                                                                    <div class="access">
                                                                        <a class="btn-remove1" title="Remove This Item" href="#">{{ __('Remove') }}</a> <a class="btn-edit" title="Edit item" href="#"><i class="fa fa-pencil"></i><span class="hidden">{{ __('Edititem') }}</span></a>
                                                                    </div>
                                                        ...
                                                        <li class="item">
                                                            <div class="item-inner">
                                                                <a class="product-image" title="Product tilte is here" href="product-detail.html"><img alt="Product tilte is here" src="images/products/product-fashion-4.jpg"></a>
                                                                <div class="product-details">
                                                    ...
                                                    <div class="actions">
                                                        <a href="shopping-cart.html" class="view-cart"><span>{{ __('ViewCart') }}</span></a>
