    ...
    <ul class="nav-right">
        ...
        <li class="user-profile dropdown dropdown-animated scale-left">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img class="profile-img img-fluid" src="{{ asset('uploads/user/avatar/no-image.jpg')}}" alt="">
            </a>
                ...
                <li>
                    <ul class="list-media">
                        <li class="list-item p-15">
                            <div class="media-img">
                                <img src="{{ asset('uploads/user/avatar/no-image.jpg') }}" alt="">
                            </div>
                            <div class="info">
                                <span class="title text-semibold">Huỳnh</span>
                            </div>
                        </li>
                    </ul>
                </li>
