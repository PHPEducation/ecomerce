                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('editCategory') }}">{{ trans('home_admin.Edit Category') }}</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('addProduct') }}">{{ trans('home_admin.Add Category') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('editProduct') }}">{{ trans('home_admin.Edit Category') }}</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('editUser') }}">{{ trans('home_admin.Edit User') }}</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
