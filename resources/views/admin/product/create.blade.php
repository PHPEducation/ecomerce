...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-8">
                    {!! Form::open(['method' => 'POST', 'url' => 'admin/products', 'files' => true, 'id' => 'form-validation', 'novalidate' => 'novalidate', 'role' => 'form']) !!}
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                {!! Form::file('thumbnail', ['class' => 'form-control', 'id' => 'product-thumbnail']) !!}
                                {!! $errors->first('thumbnail', '<p class="errors_validate">:message</p>') !!}
                                <img src="{{ asset('uploads/products/thumbnail/no-image.jpg') }}" alt="" id="product-thumbnail-show">
                            </div>
                        </div>
                        <div class="form-group row">
                            {!! Form::label(trans('home.image_description'), null, ['class' => 'col-sm-4 col-form-label control-label']) !!}
                            <div class="col-sm-8">
                                {!! Form::file('images[]', ['class' => 'form-control', 'multiple' => 'multiple', 'id' => 'uploadFile']) !!}
