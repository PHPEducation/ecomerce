...
class PageController extends Controller
{
   public function __construct()
    ...
    public function detailProduct($id)
    {
        ...
        $topproducts = Product::where('promotion_price', '<>', '0')->paginate(config('app.paginate'));
...
<
    ...
    public function postLogin(validationLoginRequest $req)
    {
        ...
        if($user)
        {
            ...
            {
                return redirect()->back()->with(['flag'=>'success','message'=>'{{ trans('home.success')}}']);
            }
            else
            {
        ...
        {
           return redirect()->back()->with(['flag'=>'danger','message'=>'{{ trans('home.notActive')}}']);
        }
